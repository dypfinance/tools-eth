        ...
        const columns = [
            {
                ...
                sortable: true,
                // minWidth: '145px',
                cell: txn => <a className='l-clr-purple' href={`https://v2.info.uniswap.org/token/${txn.id}`} style={{whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}} title={txn.name}>{txn.name}</a>
            },
            ...
            <div>
                <div className='row px-3'>
                    <div className='col-md-6'>
                        ...
                        <p className='d-block'>Showing Uniswap Top Tokens</p>
                    </div>
                    <div className='col-md-6'>
