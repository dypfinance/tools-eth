...
export default class Farms extends React.Component {
    ...
    fetchFarms = async () => {
        try {
            let farms = await window.$.get(`${window.config.farm_api}/api/farm-info/eth/`)
            ...
            <div>
                <div className='row px-3'>
                    <div className='col-md-6'>
                        ...
                        <p className='d-block' style={{fontSize: '11px'}}>This list does not imply endorsement by DeFi Yield Protocol.
